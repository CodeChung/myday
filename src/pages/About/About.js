...
import sohn from '../../images/biopic.JPG'
                ...
                <div className='swiper-container'>
                    ...
                    <Swiper {...params}>
                        <div className='about-swipe'>
                            <div class="flip-card about-swipe">
                        ...
                        <div className='about-swipe'>
                            <div class="flip-card about-swipe">
                                <div class="flip-card-inner">
                                    ...
                                    <div class="flip-card-back">
                                        <p>
                                            "Good massage! I came in with a lot of pain and left feeling relaxed and relieved. Very clean and peaceful environment."
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='about-swipe'>
                            <div class="flip-card about-swipe">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <h2>Crystal K.</h2>
                                        <img src="https://s3-media0.fl.yelpcdn.com/photo/uVNJIewA2QB1N7UNhFj5Mg/120s.jpg" alt="Avatar" />
                                        <img src={rating} alt='rating' />
                                    </div>
                                    <div class="flip-card-back">
                                        <p>
